...
while(i < starWarsCharacters.length) {
  crewMass += starWarsCharacters.length
  i++
}
...
if (crewMass < 500) {
Nave= ("Ship is under loaded");
} else if (crewMass >= 500  && crewMass < 700) {
Nave=("Ship is half loaded")
} else if (crewMass >= 700 && crewMass < 900) {
Nave=("Warning: Load is over 700")
} else if (crewMass >= 900 && crewMass < 1000) {
Nave=("Critical Load: Over 900")
} else{
Nave="DANGER! OVERLOAD ALERT: escape from ship now!";
}
console.log(Nave)
/* ESERCIZIO 8
